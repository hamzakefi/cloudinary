        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <MenuItem  onClick={()=>{navigate('/AddFood') && handleCloseNavMenu();} } >
                <Typography textAlign="center" >AddContact</Typography>
              </MenuItem>

              <MenuItem   onClick={()=>{navigate('/listfood') && handleCloseNavMenu();} } >
              <Typography textAlign="center"  >Listfood</Typography>
            </MenuItem>
